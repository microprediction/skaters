...
\paragraph{Scope.}
Five hundred change-series, one-step horizon. Prophet, multi-step horizons, raw
levels, and zero-shot foundation models
\citep{ansari2024chronos,das2024timesfm,woo2024moirai,rasul2023lagllama} --- which
require a fundamentally different, no-refit evaluation protocol --- are left to an
extended study.
