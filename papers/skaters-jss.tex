...
\pkg{skaters} performs online univariate time-series forecasting in which every
...
downstream score such as CRPS. We call the arrangement \emph{model first, conform
last}. The library is written twice, in pure \proglang{Python} and in
