...
likelihood trunk + CRPS leaf       & 89.5\,\% & \textbf{60.1\,\%} & \textbf{3.01} \\
bare CRPS leaf (no trunk)          & 80.8\,\% & 60.3\,\% & 2.96 \\
\bottomrule
\end{tabular}
\caption{Effect of the terminal-leaf objective. The middle row is the
\emph{model first, conform last} recipe. A general likelihood policy is
essentially even with conformal on CRPS over independent families ($48.7\%$);
repointing only the terminal leaf to CRPS lifts that to $60.1\%$ and raises
